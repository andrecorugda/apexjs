...
if(typeof globalThis.Buffer==='undefined')globalThis.Buffer={from:function(d,e){if(e==='base64')return b64(d);if(typeof d==='string')return new globalThis.TextEncoder().encode(d);return new Uint8Array(d);},isBuffer:function(){return false;}};
